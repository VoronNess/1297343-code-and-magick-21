...
let RIGHT_DIRECTION = 5;

let getFireballSpeed = (isMovingLeft) => {
...
let getWizardX = (gameFieldWidth) => {
  return (gameFieldWidth - wizardWidth) / HALF;
};

let ONE_THIRD = 3;

let getWizardY = (gameFieldHeight) => {
  return gameFieldHeight / ONE_THIRD;
};
